...
export class StudyCard {
    ...
    constructor(
        ...
        private readonly cardHint: HTMLDivElement,
        private readonly cardCounter: HTMLDivElement,
        private readonly cardCtrls: HTMLDivElement,
...
export function createClearDialog(onConfirm: () => void): {
    open: () => void;
    close: () => void;
} {
    const dialog = document.createElement('div');
